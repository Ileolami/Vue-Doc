---
title: Accessibility
description: Learn how to make your Vue applications accessible
tableOfContents: {maxHeadingLevel: 2}
---

import { Aside, Code, LinkButton, Tabs, TabItem, Card, LinkCard } from "@astrojs/starlight/components";
import { Quiz, QuizOption } from 'starlight-videos/components'
import Form from '../../../components/accessibility/form.vue'

Web accessibility (also known as **a11y**) refers to the practice of creating websites that can be used by anyone — such as a person with a disability, a slow connection, outdated or broken hardware or simply someone in an unfavorable environment. For example, adding subtitles to a video would help people with ear impairment and your users who are in a loud environment who can't hear their phone. Similarly, making sure your text isn't too low contrast will help both your low-vision users and your users who are trying to use their phone in bright sunlight.

<Card title="Want to learn more?" icon="open-book">
...
<LinkCard title="Read documentation on skip link to main content" href="https://www.w3.org/WAI/WCAG21/Techniques/general/G1.html" variant="secondary"/>
...
```
<LinkCard title ="Read more headings" href='https://www.w3.org/TR/UNDERSTANDING-WCAG20/navigation-mechanisms-descriptive.html' variant="secondary" />
...
<LinkCard href="https://www.w3.org/TR/wai-aria-1.2/#landmark_roles" title="Read more about landmarks" variant="secondary" />
...
![Labelled input](/accessibility/AccessibleLabelChromeDevTools.Cd99Z50e.png)
...
![Description](/accessibility/AccessibleARIAdescribedby.B-uvz_GC.png)

### Placeholder​
Avoid using placeholders as they can confuse many users.

One of the issues with placeholders is that they don't meet the color contrast criteria by default; fixing the color contrast makes the placeholder look like pre-populated data in the input fields. Looking at the following example, you can see that the Last Name placeholder which meets the [color contrast criteria](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum.html) looks like pre-populated data:
...
<TabItem label="CSS">
```css/* https://www.w3schools.com/howto/howto_css_placeholder.asp */
...
<TabItem label="Preview" default>
  <div class="preview"><Form client:load /></div>
</TabItem>
</Tabs>
...
You can do this because the search button will help visual users identify the purpose of the input field.

You can use CSS to visually hide elements but keep them available for assistive technology:
...
<Quiz title="What is the main purpose of a 'skip link' in web accessibility?">
  <QuizOption>
    To skip loading images on a page
  </QuizOption>
  <QuizOption correct>
    To allow users to jump directly to the main content, bypassing repeated navigation links
  </QuizOption>
  <QuizOption>
    To skip form validation
  </QuizOption>
  <QuizOption>
    To skip to the page footer
  </QuizOption>
</Quiz>

<Quiz title="Which ARIA role is used to identify the main content area of a web page?">
  <QuizOption>
    role="navigation"
  </QuizOption>
  <QuizOption correct>
...
<Quiz title="Why should you avoid using only placeholders as labels for form fields?">
  <QuizOption>
    Placeholders are always visible and easy to read
  </QuizOption>
  <QuizOption correct>
    Placeholders can confuse users and often do not meet color contrast requirements
  </QuizOption>
  <QuizOption>
    Placeholders are required for accessibility
  </QuizOption>
  <QuizOption>
    Placeholders automatically provide ARIA descriptions
  </QuizOption>
</Quiz>

<Quiz title="Which of the following is NOT a category of disability considered in web accessibility?">
  <QuizOption>
    Visual
  </QuizOption>
  <QuizOption>
...
<Quiz title="What does the 'Robust' principle in WCAG stand for?">
  <QuizOption>
    The website must be fast and scalable
  </QuizOption>
  <QuizOption correct>
    Users must be able to access the content as technologies advance
  </QuizOption>
  <QuizOption>
    The website must use robust JavaScript frameworks
  </QuizOption>
  <QuizOption>
    The website must be robust against security attacks
  </QuizOption>
</Quiz>