...
## Quiz
<Quiz title="1. What is the purpose of the `key` attribute in a `<Transition>` component?">
  <QuizOption correct>To force the re-render of a DOM element in order for a transition to occur</QuizOption>
  <QuizOption>To specify the name of the transition</QuizOption>
  <QuizOption>To define which CSS properties should be animated</QuizOption>
  <QuizOption>To set the duration of the transition</QuizOption>
</Quiz>

<Quiz title="2. Which of the following transition hooks are available in Vue's `<Transition>` component?" multiple>
  <QuizOption correct>@before-enter</QuizOption>
  <QuizOption correct>@enter</QuizOption>
  <QuizOption correct>@leave</QuizOption>
  <QuizOption>@transition-start</QuizOption>
</Quiz>

<Quiz title="3. Which of these animation techniques is covered in the Vue documentation?">
  <QuizOption correct>Toggling CSS classes</QuizOption>
  <QuizOption>State-driven animations via style bindings</QuizOption>
  <QuizOption>Using the `<Transition>` component</QuizOption>
  <QuizOption>Using the `<TransitionGroup>` component</QuizOption>
</Quiz>
