...
## Quiz
<Quiz title="What is the main purpose of the `<Teleport>` component in Vue.js?">
  <QuizOption correct>
    To render part of a component's template in a different place in the DOM hierarchy
  </QuizOption>
  <QuizOption>
...
<Quiz title="Which prop is used to specify where the content of `<Teleport>` should be rendered?">
  <QuizOption>
    target
  </QuizOption>
  <QuizOption correct>
...
<Quiz title="What happens if the target element for `<Teleport>` does not exist in the DOM when it is mounted?">
  <QuizOption correct>
    Vue will report an error
  </QuizOption>
  <QuizOption>
    The content will be rendered inline
  </QuizOption>
  <QuizOption>
    The content will be ignored
  </QuizOption>
  <QuizOption>
    Vue will create the target element automatically
  </QuizOption>
</Quiz>
