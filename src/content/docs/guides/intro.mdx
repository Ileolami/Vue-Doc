---
title: Introduction
description: An overview on Vue.js, its uses, API styles etc
...
<Aside type="caution" title="Prerequisites">
  ...
  JavaScript. If you are totally new to frontend development, it might not be
  the best idea to jump right into a framework as your first step - grasp the
  basics and then come back! You can refresh your knowledge level with these
  overviews for
  [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript),
  [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML), and
  [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS) if needed. Prior
...
>
  ...
  <span style="margin-top: -4px">Try it in the Playground</span>
</a>
...
```
<a href="https://play.vuejs.org/#" class="inline-link">
  <Icon name="seti:video"/>
  <span style="margin-top: -4px">Try it in the Playground</span>
</a>
