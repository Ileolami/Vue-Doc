...
<a href="https://www.vuemastery.com/courses/" style="display: flex; align-items: center; gap: 1rem; margin: 2rem 0; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 1rem; border-radius: 0.5rem;">
  <img src="/src/assets/vuemastery-graphical-link-96x56.png" alt="Vue logo" />
  <span>Learn Vue with video tutorials on <span style="color: #41b883;">VueMastery.com</span></span>
  <img src="/src/assets/vue-mastery-logo.png" alt="Vue logo" width="100px"/>
</a>
