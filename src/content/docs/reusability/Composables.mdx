...
<Aside type="note">
  This section assumes you are familiar with the Composition API.  
  If you have only used the Options API so far, switch your API Preference to "Composition API" (using the toggle at the top of the left sidebar),
  <img src="/public/option-API-btn.png" alt="API Preference toggle" width="400" style="display:inline; vertical-align:middle;" />
  and review the [Reactivity Fundamentals](/essentials/reactivity) and [Lifecycle Hooks](https://vuejs.org/guide/essentials/lifecycle.html) chapters before continuing.
</Aside>
...
```
<div style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 0; background-color: rgba(56, 54, 54, 0.17); border-radius:10px; padding: 20px;">
<MousePosition client:load/>
</div>

[<Badge text="►" size="large"/> Try it in the playground](https://play.vuejs.org/#)
