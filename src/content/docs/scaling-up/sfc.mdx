...
## Quiz 
<Quiz title="What is a key benefit of using Vue Single-File Components (SFCs)?">
  <QuizOption>
    They require no build step at all
  </QuizOption>
  <QuizOption correct>
    They colocate template, logic, and styles for better maintainability
  </QuizOption>
  <QuizOption>
    They only support JavaScript logic
  </QuizOption>
  <QuizOption>
    They prevent the use of scoped CSS
  </QuizOption>
</Quiz>

<Quiz title="How does Vue recommend thinking about 'separation of concerns' in modern UI development?">
  <QuizOption>
    By strictly separating HTML, CSS, and JavaScript into different files
  </QuizOption>
  <QuizOption correct>
    By dividing code into loosely-coupled components that colocate template, logic, and styles
  </QuizOption>
  <QuizOption>
    By writing all code in a single global file
  </QuizOption>
  <QuizOption>
    By avoiding the use of components altogether
  </QuizOption>
</Quiz>