...
<Quiz title="What is the main benefit of automated testing in Vue applications?">
  <QuizOption>
    It makes the application load faster
  </QuizOption>
  <QuizOption correct>
    It helps prevent regressions and increases developer confidence
  </QuizOption>
  <QuizOption>
...
<Quiz title="Which testing type focuses on verifying the smallest units of code, such as functions or composables?">
  <QuizOption>
    Component testing
  </QuizOption>
  <QuizOption correct>
...
<Quiz title="Which tool is recommended for unit testing in Vite-based Vue projects?">
  <QuizOption>
    Jest
  </QuizOption>
  <QuizOption correct>
...
<Quiz title="What is the primary focus of component testing in Vue?">
  <QuizOption>
    Testing private methods of a component
  </QuizOption>
  <QuizOption correct>
    Testing the component's public interface, such as props, events, and slots
  </QuizOption>
  <QuizOption>
    Testing the application's backend
  </QuizOption>
  <QuizOption>
    Testing only the styles of a component
  </QuizOption>
</Quiz>

<Quiz title="Which testing type simulates real user interactions across multiple pages and network requests?">
  <QuizOption>
    Unit testing
  </QuizOption>
  <QuizOption>
