...
<Quiz title="What is the recommended state management library for new Vue applications?">
  <QuizOption>
    Vuex
  </QuizOption>
  <QuizOption>
...
<Quiz title="Why is using a singleton store pattern problematic with Server-Side Rendering (SSR)?">
  <QuizOption>
    It increases the bundle size
  </QuizOption>
  <QuizOption correct>
    It can cause cross-request state pollution by sharing state between users
  </QuizOption>
  <QuizOption>
    It disables reactivity
  </QuizOption>
  <QuizOption>
    It prevents hot module replacement
  </QuizOption>
</Quiz>